            ...
            <div className="flex text-black gap-5 mt-5 items-center">
              <div className="w-[34.5rem] h-56 flex bg-white rounded-sm rounded-br-2xl">
                ...
                <div className="px-5 py-8 flex flex-col items-start justify-center">
                  <div
                    className="font-acumin-black text-[1.6rem]"
                    data-aos="fade-right"
                  ...
                  <div
                    className="font-segoeUI text-[0.75rem] my-4"
                    data-aos="fade-right"
                    data-aos-easing="linear"
                    data-aos-duration="500"
                  >
                  ...
                  <button className="flex group">
                    <div
                      className="font-segoeUI-bold text-[0.8rem]"
                      data-aos="fade-right"
                      data-aos-easing="linear"
                      data-aos-duration="500"
                    >
                    ...
                    <div
                      className="font-segoeUI-bold text-[0.8rem] ml-5 group-hover:ml-7 duration-[800ms]"
                      data-aos="fade-right"
                      data-aos-easing="linear"
                      data-aos-duration="500"
                    >
